...
const GameOver: React.FC<GameOverProps> = ({ score, coins, onRestart, onHome }) => {
  ...
  return (
    <div className="absolute inset-0 bg-red-900/90 backdrop-blur-md flex flex-col items-center justify-center p-1 sm:p-2 md:p-3 lg:p-4 z-40 overflow-y-auto" style={{ WebkitOverflowScrolling: 'touch', overscrollBehavior: 'contain', touchAction: 'pan-y', overflowY: 'scroll' }}>
